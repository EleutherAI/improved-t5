...
python -m t5x.train \
    ...
    --gin.MODEL_DIR=\"'/fsx/lintangsutawika/improved_t5/ckpts/METRO/alibi_relpos_pile_mlm/finetune_t0_train/'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/lintangsutawika/improved_t5/ckpts/METRO/alibi_relpos_pile_mlm/checkpoint_125000/'\" \
