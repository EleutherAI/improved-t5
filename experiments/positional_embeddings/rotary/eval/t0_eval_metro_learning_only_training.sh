...
python -m t5x.train \
    ...
    --gin.MODEL_DIR=\"'/fsx/lintangsutawika/improved_t5/ckpts/METRO/metro_inspired_learning_only_pile/finetune_t0_eval/'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/lintangsutawika/improved_t5/ckpts/METRO/metro_inspired_learning_only_pile/finetune_t0_train/checkpoint_135000'\" \
