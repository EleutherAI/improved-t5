...
python -m t5x.train \
    ...
    --gin.BATCH_SIZE=2048 \
    --gin.MODEL_DIR=\"'/fsx/lintangsutawika/improved_t5/ckpts/sglue_finetune_with_alibi_plus_relpos/'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/lintangsutawika/improved_t5/ckpts/pile_prefix_lm_with_alibi_plus_relpos/checkpoint_125000/'\" \
