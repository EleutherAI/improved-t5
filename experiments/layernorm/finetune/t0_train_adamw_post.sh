...
python -m t5x.train \
    ...
    --gin.MODEL_DIR=\"'/fsx/lintangsutawika/improved_t5/ckpts/LayerNorm/pile_mlm_adamw_post/finetune_t0_train/'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/lintangsutawika/improved_t5/ckpts/LayerNorm/pile_mlm_adamw_post/checkpoint_125000/'\" \
