...
python -m t5x.train \
    ...
    --gin.TRAIN_STEPS=2_262_144 \
    --gin.SAVING_PERIOD=5000 \
    --gin.MODEL_DIR=\"gs://improved-t5/ckpts/v2_xl_mlm/_finetune/checkpoint_2000000/sglue_finetune\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"gs://improved-t5/ckpts/v2_xl_mlm/checkpoint_2000000\" \
