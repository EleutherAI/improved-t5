...
python -m t5x.train \
    ...
    --gin.MODEL_DIR=\""gs://improved-t5/ckpts/v2_large_mlm/_finetune/checkpoint_${1}/flan2022_finetune"\" \
    --gin.INITIAL_CHECKPOINT_PATH=\""gs://improved-t5/ckpts/v2_large_mlm/checkpoint_${1}"\" \
