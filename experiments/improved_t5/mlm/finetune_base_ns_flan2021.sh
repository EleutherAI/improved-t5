...
python -m t5x.train \
    ...
    --gin.MODEL_DIR=\"gs://improved-t5/ckpts/v2_base_mlm_ns/checkpoint_1000000/flan2021_finetune\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"gs://improved-t5/ckpts/v2_base_mlm_ns/checkpoint_1000000\" \
