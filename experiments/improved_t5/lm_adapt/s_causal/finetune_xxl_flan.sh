...
python -m t5x.train \
    ...
    --gin.TRAIN_STEPS=1_114_000 \
    --gin.SAVING_PERIOD=10_000 \
    --gin.MODEL_DIR=\"gs://improved-t5/ckpts/v2_xxl_mlm/checkpoint_1000000/lm_adapt_sc_flan_finetune\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"gs://improved-t5/ckpts/v2_xxl_mlm/checkpoint_1000000/lm_adapt_sc/checkpoint_1100000\" \
