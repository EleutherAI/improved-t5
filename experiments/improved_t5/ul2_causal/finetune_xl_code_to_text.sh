...
python -m t5x.train \
    ...
    --gin.MODEL_DIR=\"gs://improved-t5/ckpts/v2_xl/checkpoint_1000000/codexglue_${CODE_LANG}_finetune\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"gs://improved-t5/ckpts/v2_xl/checkpoint_1000000\" \
