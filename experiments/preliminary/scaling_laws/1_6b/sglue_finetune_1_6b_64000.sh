...
python -m t5x.train \
    ...
    --gin.TRAIN_STEPS=192_000 \
    --gin.MODEL_DIR=\"'/fsx/aran/jax/ckpts/scaling/1_6b/vanilla_64k_finetune'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/aran/jax/ckpts/scaling/1_6b/checkpoint_64000'\" \
