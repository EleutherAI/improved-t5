...
python -m t5x.train \
    ...
    --gin.TRAIN_STEPS=184_000 \
    --gin.MODEL_DIR=\"'/fsx/aran/jax/ckpts/scaling/25m/vanilla_56k_finetune'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/aran/jax/ckpts/scaling/25m/checkpoint_56000'\" \
