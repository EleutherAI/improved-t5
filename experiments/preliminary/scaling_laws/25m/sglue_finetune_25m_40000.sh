...
python -m t5x.train \
    ...
    --gin.TRAIN_STEPS=168_000 \
    --gin.MODEL_DIR=\"'/fsx/aran/jax/ckpts/scaling/25m/vanilla_40k_finetune'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/aran/jax/ckpts/scaling/25m/checkpoint_40000'\" \
