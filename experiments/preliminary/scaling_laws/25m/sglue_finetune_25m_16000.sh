...
python -m t5x.train \
    ...
    --gin_file="configs/size/25m/vanilla.gin" \
    --gin_file="${CONFIG_PATH}/mode/gpu.gin" \
    --gin.TRAIN_STEPS=144_000 \
    --gin.MODEL_DIR=\"'/fsx/aran/jax/ckpts/scaling/25m/vanilla_16k_finetune'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/aran/jax/ckpts/scaling/25m/checkpoint_16000'\" \
