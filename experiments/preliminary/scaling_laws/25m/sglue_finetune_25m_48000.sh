...
python -m t5x.train \
    ...
    --gin.TRAIN_STEPS=176_000 \
    --gin.MODEL_DIR=\"'/fsx/aran/jax/ckpts/scaling/25m/vanilla_48k_finetune'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/aran/jax/ckpts/scaling/25m/checkpoint_48000'\" \
