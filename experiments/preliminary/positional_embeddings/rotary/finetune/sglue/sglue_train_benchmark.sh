...
python -m t5x.train \
    ...
    --gin.BATCH_SIZE=2048 \
    --gin.MODEL_DIR=\"'/fsx/lintangsutawika/improved_t5/ckpts/rotary/benchmark_pile_mlm/finetune_sglue/'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/lintangsutawika/improved_t5/ckpts/rotary/benchmark_pile_mlm/checkpoint_125000/'\" \
