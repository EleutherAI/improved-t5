...
python -m t5x.train \
    ...
    --gin.MODEL_DIR=\"'/fsx/lintangsutawika/improved_t5/ckpts/920m_pile_ul2_causal_0_60/sglue_32k/'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/lintangsutawika/improved_t5/ckpts/920m_pile_ul2_causal_0_60/checkpoint_32000/'\" \
