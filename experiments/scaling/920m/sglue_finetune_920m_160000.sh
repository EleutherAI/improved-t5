...
python -m t5x.train \
    ...
    --gin.TRAIN_STEPS=288_000 \
    --gin.MODEL_DIR=\"'/fsx/aran/jax/ckpts/scaling/920m/vanilla_160k_finetune'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/aran/jax/ckpts/scaling/920m/checkpoint_160000'\" \
