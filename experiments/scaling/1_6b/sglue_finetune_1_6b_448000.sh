...
python -m t5x.train \
    ...
    --gin_file="${CONFIG_PATH}/size/1_6b/vanilla.gin" \
    --gin_file="${CONFIG_PATH}/mode/gpu.gin" \
    --gin.TRAIN_STEPS=576_000 \
    --gin.MODEL_DIR=\"'/fsx/aran/jax/ckpts/scaling/1_6b/vanilla_448k_finetune'\" \
    --gin.INITIAL_CHECKPOINT_PATH=\"'/fsx/aran/jax/ckpts/scaling/1_6b/checkpoint_448000'\" \
